...
const columns: ColumnDef<TransactionHistoryRow>[] = [
  ...
  },
  {
    ...
    cell: ({ row }) => (
      <div className="apitalize">{row.original.description}</div>
    ),
  },
  {
    accessorKey: "date",
...
const TransactionsTable = ({ from, to }: Props) => {
  ...
  return (
    <div className="w-full ">
      <div className="flex flex-warp items-end gap-2 py-4 justify-between">
      ...
      <SkeltonWrapper isLoading={history.isFetching}>
